...
public class Queen extends DiagRowColPiece {
  public Queen(int row, int column, Colour colour) {
    super(row, column, PieceType.QUEEN, colour);
  }

  public Queen(Position position, Colour colour) {
    super(position, PieceType.QUEEN, colour);
  }
