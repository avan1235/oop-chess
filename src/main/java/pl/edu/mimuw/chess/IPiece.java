...
public interface IPiece {
  public static final Square N = new Square(0, 1);
  public static final Square W = new Square(-1, 0);
  public static final Square S = new Square(0, -1);
  public static final Square E = new Square(1, 0);
